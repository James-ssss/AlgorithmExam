...
namespace AlgorithmExam.MinimalTree
{
    public class Edge
    {
    ...
    public static class TreeGraphMethods
    {
        ...
        // Алгоритм Прима. Выбираем случайно начальную вершину, затем идем по наименьшему по весу ребру, которое не образует цикл, до того как не обойдем все ноды
